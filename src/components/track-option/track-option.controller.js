...
.controller('TrackOptionController', ['$rootScope', '$log', '$scope', '$state', 'FailedRequestService', 'RoutingConfig', 'TrackService',
        function($rootScope, $log, $scope, $state, FailedRequestService, RoutingConfig, TrackService) {
    ...
    $scope.filter = () => {
        $state.go(RoutingConfig.states.get('filter'), { track: $scope.track });
    };
