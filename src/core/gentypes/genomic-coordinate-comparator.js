...
class GenomicCoordinateComparator {
    ...
    compare(o1, o2) {
        ...
        let o1ContigNameIdx = referenceGenome.contigs.map(it => it.id).indexOf(o1.contigName);
        if (o1ContigNameIdx === -1) {
            throw new UnknownContigException(referenceGenome, o1.contigName);
        }
        let o2ContigNameIdx = referenceGenome.contigs.map(it => it.id).indexOf(o2.contigName);
